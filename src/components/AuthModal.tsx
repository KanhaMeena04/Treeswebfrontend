...
export const AuthModal = ({ isOpen, onClose, onLogin }: AuthModalProps) => {
  ...
  const validateLogin = () => {
    ...
    if (loginMethod === 'username' && !username) newErrors.username = 'Username is required';
          ...
          <TabsContent value="login" className="space-y-6 mt-6">
            ...
            <div className="space-y-3 max-w-md mx-auto">
              ...
              <Input
                ...
                className={`font-inter h-12 text-base ${errors.email || errors.username ? 'border-red-500' : ''}`}
              />
            ...
            <div className="space-y-3 max-w-md mx-auto">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`font-inter h-12 text-base pr-12 ${errors.password ? 'border-red-500' : ''}`}
                />
                <Button
                  type="button"
                  variant="ghost"
            ...
            <div className="max-w-2xl mx-auto space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <Label htmlFor="fullName" className="font-inter text-base">Full Name</Label>
                  <Input
                    id="fullName"
                    placeholder="Enter your full name"
                    value={fullName}
                    onChange={(e) => setFullName(e.target.value)}
                    className={`font-inter h-12 text-base ${errors.fullName ? 'border-red-500' : ''}`}
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <Label htmlFor="signupEmail" className="font-inter text-base">Email</Label>
                  <Input
                    id="signupEmail"
                    type="email"
                    ...
                    className={`font-inter h-12 text-base ${errors.email ? 'border-red-500' : ''}`}
                  />
                  {errors.email && <p className="text-sm text-red-500">{errors.email}</p>}
                </div>
              ...
              <div className="space-y-3">
                <Label htmlFor="signupPassword" className="font-inter text-base">Password</Label>
                <div className="relative">
                  <Input
                    id="signupPassword"
                    type={showPassword ? 'text' : 'password'}
              ...
              <div className="space-y-3">
                <Label htmlFor="confirmPassword" className="font-inter text-base">Confirm Password</Label>
                <div className="relative">
                  <Input
                    id="confirmPassword"
